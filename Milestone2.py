...
# orient the crystal such that the dislocations are easier to see in this
...
# we achieve this by selecting the "gripped" atoms, and calling an ASE function on them
...
nu = 0.346  # assumed Poisson Ratio
